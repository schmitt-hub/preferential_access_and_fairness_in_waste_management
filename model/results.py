...
def save_overall_results(users_and_facs_df, travel_dict, users, facs,
                         output_filename='overall_results.xlsx', percentiles=None,
                         budget_factor_list=None, strict_assign_to_one=False,
    ...
    # write the results
    write_overall_results(results_list, users_and_facs_df, travel_dict, output_filename, percentiles)
...
def save_fairness_results(users_and_facs_df, travel_dict, users, facs, output_filename='fairness_results.xlsx',
    ...
    # write the results
    write_fairness_results(results_list, users_and_facs_df, travel_dict, output_filename)


def write_greedy_results(greedy_results_list, naive_results_list, users_and_facs_df, travel_dict,
                         output_filename='greedy_results.xlsx'):
    """
...
def save_greedy_results(users_and_facs_df, travel_dict, instance_dict=None, output_filename='greedy_results.xlsx',
                        budget_factor=1.0, strict_assign_to_one=False, cap_factor=1.5, cutoff=0.2,
                        max_access=False, main_threads=1, main_tolerance=5e-3, main_time_limit=20000,
                        main_print_sol=False, main_log_file=None, main_preqlinearize=-1, post_threads=1,
                        post_tolerance=0.0, post_print_sol=False, post_log_file=None, post_preqlinearize=-1,
...
def save_cutoff_results(users_and_facs_df, travel_dict, instance_dict=None, output_filename='cutoff_results.xlsx',
                        budget_factor=1.0, strict_assign_to_one=False, cap_factor=1.5, compared_cutoff=0.2,
                        max_access=False, main_threads=1, main_tolerance=5e-3, main_time_limit=20000,
                        main_print_sol=False, main_log_file=None, main_preqlinearize_cutoff=1,
                        main_preqlinearize_nocutoff=-1, post_threads=1, post_tolerance=0.0,
    ...
    # write the results
    write_cutoff_results(cutoff_results_list, nocutoff_results_list, output_filename)
...
def save_pof_results(users_and_facs_df, travel_dict, users, facs, output_filename='pof_results.xlsx',
                     budget_factor_list=None, strict_assign_to_one=False, cap_factor=1.5, cutoff=0.2, main_threads=1,
...
def save_strict_vs_loose_results(users_and_facs_df, travel_dict, users, facs,
                                 output_filename='strict_vs_loose_results.xlsx', budget_factor=1.0, cap_factor=1.5,
                                 cutoff=0.2, max_access=False, main_threads=1, main_tolerance=5e-3,
                                 main_time_limit=20000, main_print_sol=False, main_log_file=None, main_preqlinearize=-1,
                                 post_threads=1, post_tolerance=0.0, post_print_sol=False, post_log_file=None,
                                 post_preqlinearize=-1):
    """
