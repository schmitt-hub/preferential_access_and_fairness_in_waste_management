...
def save_cap_vs_access_plot(users_and_facs_df, travel_dict, users, facs,
                            output_filename='cap_vs_access.pdf', facility_region='all',
                            budget_factor=1.0, strict_assign_to_one=False,
    ...
    # plot the figure
    plot_cap_vs_access(results, users_and_facs_df, travel_dict, output_filename, facility_region)
...
def save_overall_access_plot(users_and_facs_df, travel_dict, users, facs, output_filename='overall_access.pdf',
                             budget_factor_list=None, strict_assign_to_one=False, cap_factor=1.5, cutoff=0.2,
    ...
    # plot the figure
    plot_overall_access(results_list, users_and_facs_df, travel_dict, output_filename)


def plot_utilization_percentiles(results_list, users_and_facs_df, travel_dict,
                                 output_filename='utilization_percentiles.pdf', percentiles=None):
    """
...
def save_utilization_percentiles_plot(users_and_facs_df, travel_dict, users, facs,
                                      ...
                                      max_access=False, main_threads=1, main_tolerance=5e-3, main_time_limit=20000,
                                      main_print_sol=False, main_log_file=None, main_preqlinearize=-1, post_threads=1,
                                      post_tolerance=0.0, post_print_sol=False, post_log_file=None,
                                      post_preqlinearize=-1):
    """
    plot the utilization of open facilities for three different percentiles for different budgets
    ...
    # plot the figure
    plot_utilization_percentiles(results_list, users_and_facs_df, travel_dict, output_filename, percentiles)


def plot_utilization_distribution(results_list, users_and_facs_df, travel_dict,
                                  output_filename='utilization_distribution.pdf', facility_region='all'):
    """
...
def save_utilization_distribution_plot(users_and_facs_df, travel_dict, users, facs,
                                       output_filename='utilization_distribution.pdf', budget_factor_list=None,
                                       facility_region='all', strict_assign_to_one=False, cap_factor=1.5, cutoff=0.2,
                                       max_access=False, main_threads=1, main_tolerance=5e-3, main_time_limit=20000,
                                       main_print_sol=False, main_log_file=None, main_preqlinearize=-1, post_threads=1,
                                       post_tolerance=0.0, post_print_sol=False, post_log_file=None,
                                       post_preqlinearize=-1):
    ...
    # plot the figure
    plot_utilization_distribution(results_list, users_and_facs_df, travel_dict, output_filename, facility_region)


def plot_distance_percentiles(results_list, users_and_facs_df, output_filename='distance_percentiles.pdf',
                              percentiles=None, facility_region='all'):
    """
...
def save_distance_percentiles_plot(users_and_facs_df, travel_dict, users, facs,
                                   output_filename='distance_percentiles.pdf', percentiles=None,
                                   budget_factor_list=None, facility_region='all',
                                   strict_assign_to_one=False, cap_factor=1.5, cutoff=0.2, max_access=False,
                                   main_threads=1, main_tolerance=5e-3, main_time_limit=20000, main_print_sol=False,
    ...
    # plot the figure
    plot_distance_percentiles(results_list, users_and_facs_df, output_filename, percentiles, facility_region)
...
def save_strict_vs_loose_plot(users_and_facs_df, travel_dict, users, facs, output_filename='strict_vs_loose.pdf',
                              budget_factor_list=None, cap_factor=1.5, cutoff=0.2, max_access=False, main_threads=1,
    ...
    # plot the figure
    plot_strict_vs_loose(strict_results_list, loose_results_list, output_filename)
...
def save_cutoff_vs_nocutoff_plot(users_and_facs_df, travel_dict, users, facs, output_filename='cutoff_vs_nocutoff.pdf',
                                 budget_factor_list=None, strict_assign_to_one=False, cap_factor=1.5,
    ...
    # plot the figure
    plot_cutoff_vs_nocutoff(cutoff_results_list, nocutoff_results_list, output_filename)
